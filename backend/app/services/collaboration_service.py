...
class CollaborationService:
    ...
    def get_request(request_id, user_id=None):
        """Retrieve a request, optionally verify ownership for certain actions."""
    ...
    def get_incoming_requests(owner_id, status=None):
        """Get all collaboration requests for projects owned by the user."""
